...
headerAvatar.AddChildren({ avatarIcon });
header.AddChildren({
    headerAddress,
    headerAvatar,
});
...
searchBar.AddChildren({ searchLabel });
...
catPopularCircle.AddChildren({ catPopularIcon });
...
catPizzaCircle.AddChildren({ catPizzaIcon });
...
catSushiCircle.AddChildren({ catSushiIcon });
...
catSaladCircle.AddChildren({ catSaladIcon });
...
catRamenCircle.AddChildren({ catRamenIcon });
...
heroBanner.AddChildren({ heroImage });
...
card1TagRating.AddChildren({ card1TagRatingLabel });
...
card1TagTime.AddChildren({ card1TagTimeLabel });
...
card1TagDelivery.AddChildren({ card1TagDeliveryLabel });
...
card2TagRating.AddChildren({ card2TagRatingLabel });
...
card2TagTime.AddChildren({ card2TagTimeLabel });
...
card2TagDelivery.AddChildren({ card2TagDeliveryLabel });
