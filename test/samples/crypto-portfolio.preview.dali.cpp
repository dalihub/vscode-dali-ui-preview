...
balanceChangePill.AddChildren({ balanceChangePct });
...
pill1H.AddChildren({ pill1HLabel });
...
pill1D.AddChildren({ pill1DLabel });
...
pill1W.AddChildren({ pill1WLabel });
...
pill1M.AddChildren({ pill1MLabel });
...
pill1Y.AddChildren({ pill1YLabel });
...
btcIcon.AddChildren({ btcIconLabel });
...
ethIcon.AddChildren({ ethIconLabel });
...
solIcon.AddChildren({ solIconLabel });
...
adaIcon.AddChildren({ adaIconLabel });
