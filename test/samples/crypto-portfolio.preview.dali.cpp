...
return StackLayout::New(StackOrientation::VERTICAL)
    ...
    .Children({
                ...
                FlexLayout::New()
                    ...
                    .Children({
                        FlexLayout::New()
                            ...
                            .SetPadding(Extents(42, 42, 21, 21))
                            .Children({
        ...
        FlexLayout::New()
            ...
            .SetPadding(Extents(56, 56, 56, 49))
            .Children({
                // Chart bars
                FlexLayout::New()
                    .SetDirection(FlexDirection::ROW)
                ...
                FlexLayout::New()
                    ...
                    .SetRequestedWidth(MATCH_PARENT)
                    .Children({
                        FlexLayout::New().SetDirection(FlexDirection::ROW).SetJustifyContent(FlexJustify::CENTER).SetAlignItems(FlexAlign::CENTER).SetBackgroundColor(UiColor(0x1a1d30)).SetCornerRadius(42.0f).SetPadding(Extents(56, 56, 21, 21)).Children({
                            Label::New("1H").SetFontSize(39).SetTextColor(UiColor(0x6b7190)),
                        }),
                        FlexLayout::New().SetDirection(FlexDirection::ROW).SetJustifyContent(FlexJustify::CENTER).SetAlignItems(FlexAlign::CENTER).SetBackgroundColor(UiColor(0x1a1d30)).SetCornerRadius(42.0f).SetPadding(Extents(56, 56, 21, 21)).Children({
                            Label::New("1D").SetFontSize(39).SetTextColor(UiColor(0x6b7190)),
                        }),
                        FlexLayout::New().SetDirection(FlexDirection::ROW).SetJustifyContent(FlexJustify::CENTER).SetAlignItems(FlexAlign::CENTER).SetBackgroundColor(UiColor(0x7c3aed)).SetCornerRadius(42.0f).SetPadding(Extents(56, 56, 21, 21)).Children({
        ...
        FlexLayout::New()
            ...
            .Children({
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetJustifyContent(FlexJustify::CENTER).SetAlignItems(FlexAlign::CENTER).SetRequestedWidth(525.0f).SetRequestedHeight(266.0f).SetBackgroundColor(UiColor(0x141628)).SetCornerRadius(56.0f).Children({
                    Label::New("↑").SetFontSize(77).SetTextColor(UiColor(0x7c3aed)),
                    Label::New("Send").SetFontSize(42).SetTextColor(UiColor(0xffffff)).SetMargin(Extents(0, 0, 21, 0)),
                }),
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetJustifyContent(FlexJustify::CENTER).SetAlignItems(FlexAlign::CENTER).SetRequestedWidth(525.0f).SetRequestedHeight(266.0f).SetBackgroundColor(UiColor(0x141628)).SetCornerRadius(56.0f).Children({
                    Label::New("↓").SetFontSize(77).SetTextColor(UiColor(0x7c3aed)),
                    Label::New("Receive").SetFontSize(42).SetTextColor(UiColor(0xffffff)).SetMargin(Extents(0, 0, 21, 0)),
                }),
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetJustifyContent(FlexJustify::CENTER).SetAlignItems(FlexAlign::CENTER).SetRequestedWidth(525.0f).SetRequestedHeight(266.0f).SetBackgroundColor(UiColor(0x141628)).SetCornerRadius(56.0f).Children({
                    Label::New("⇄").SetFontSize(77).SetTextColor(UiColor(0x7c3aed)),
                    Label::New("Swap").SetFontSize(42).SetTextColor(UiColor(0xffffff)).SetMargin(Extents(0, 0, 21, 0)),
                }),
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetJustifyContent(FlexJustify::CENTER).SetAlignItems(FlexAlign::CENTER).SetRequestedWidth(525.0f).SetRequestedHeight(266.0f).SetBackgroundColor(UiColor(0x141628)).SetCornerRadius(56.0f).Children({
                    Label::New("+").SetFontSize(84).SetTextColor(UiColor(0x7c3aed)),
                    Label::New("Buy").SetFontSize(42).SetTextColor(UiColor(0xffffff)).SetMargin(Extents(0, 0, 21, 0)),
                }),
            }),
        ...
        FlexLayout::New()
            ...
            .SetMargin(Extents(70, 70, 0, 35))
            .SetPadding(Extents(56, 56, 0, 0))
            .Children({
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetJustifyContent(FlexJustify::CENTER).SetAlignItems(FlexAlign::CENTER).SetRequestedWidth(154.0f).SetRequestedHeight(154.0f).SetBackgroundColor(UiColor(0x3a2510)).SetCornerRadius(77.0f).Children({
                    Label::New("BTC").SetFontSize(39).SetTextColor(UiColor(0xf7931a)),
                }),
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetAlignItems(FlexAlign::FLEX_START).SetRequestedWidth(910.0f).SetMargin(Extents(49, 0, 0, 0)).Children({
                    Label::New("Bitcoin").SetFontSize(53).SetTextColor(UiColor(0xffffff)),
                    Label::New("BTC · $67,420").SetFontSize(42).SetTextColor(UiColor(0x9ca3af)).SetMargin(Extents(0, 0, 11, 0)),
                }),
                ...
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetAlignItems(FlexAlign::FLEX_END).Children({
                    ...
                    Label::New("▲ 3.42%").SetFontSize(42).SetTextColor(UiColor(0x22c55e)).SetMargin(Extents(0, 0, 11, 0)),
                }),
            }),
        ...
        FlexLayout::New()
            ...
            .SetPadding(Extents(56, 56, 0, 0))
            .Children({
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetJustifyContent(FlexJustify::CENTER).SetAlignItems(FlexAlign::CENTER).SetRequestedWidth(154.0f).SetRequestedHeight(154.0f).SetBackgroundColor(UiColor(0x181e3a)).SetCornerRadius(77.0f).Children({
                ...
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetAlignItems(FlexAlign::FLEX_START).SetRequestedWidth(910.0f).SetMargin(Extents(49, 0, 0, 0)).Children({
                    ...
                    Label::New("ETH · $3,520").SetFontSize(42).SetTextColor(UiColor(0x9ca3af)).SetMargin(Extents(0, 0, 11, 0)),
                }),
                View::New().SetRequestedWidth(MATCH_PARENT).SetRequestedHeight(3.5f),
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetAlignItems(FlexAlign::FLEX_END).Children({
                    Label::New("$12,580.00").SetFontSize(53).SetTextColor(UiColor(0xffffff)),
                    Label::New("▲ 2.18%").SetFontSize(42).SetTextColor(UiColor(0x22c55e)).SetMargin(Extents(0, 0, 11, 0)),
                }),
            }),
        ...
        FlexLayout::New()
            ...
            .SetPadding(Extents(56, 56, 0, 0))
            .Children({
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetJustifyContent(FlexJustify::CENTER).SetAlignItems(FlexAlign::CENTER).SetRequestedWidth(154.0f).SetRequestedHeight(154.0f).SetBackgroundColor(UiColor(0x0a2b24)).SetCornerRadius(77.0f).Children({
                    Label::New("SOL").SetFontSize(39).SetTextColor(UiColor(0x14f195)),
                }),
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetAlignItems(FlexAlign::FLEX_START).SetRequestedWidth(910.0f).SetMargin(Extents(49, 0, 0, 0)).Children({
                    Label::New("Solana").SetFontSize(53).SetTextColor(UiColor(0xffffff)),
                    Label::New("SOL · $148.70").SetFontSize(42).SetTextColor(UiColor(0x9ca3af)).SetMargin(Extents(0, 0, 11, 0)),
                }),
                View::New().SetRequestedWidth(MATCH_PARENT).SetRequestedHeight(3.5f),
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetAlignItems(FlexAlign::FLEX_END).Children({
                    Label::New("$5,243.74").SetFontSize(53).SetTextColor(UiColor(0xffffff)),
                    Label::New("▼ 1.24%").SetFontSize(42).SetTextColor(UiColor(0xef4444)).SetMargin(Extents(0, 0, 11, 0)),
                }),
            }),
        ...
        FlexLayout::New()
            ...
            .SetPadding(Extents(56, 56, 0, 0))
            .Children({
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetJustifyContent(FlexJustify::CENTER).SetAlignItems(FlexAlign::CENTER).SetRequestedWidth(154.0f).SetRequestedHeight(154.0f).SetBackgroundColor(UiColor(0x0d1f3a)).SetCornerRadius(77.0f).Children({
                    Label::New("ADA").SetFontSize(39).SetTextColor(UiColor(0x6fa0ff)),
                }),
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetAlignItems(FlexAlign::FLEX_START).SetRequestedWidth(910.0f).SetMargin(Extents(49, 0, 0, 0)).Children({
                    Label::New("Cardano").SetFontSize(53).SetTextColor(UiColor(0xffffff)),
                    Label::New("ADA · $0.58").SetFontSize(42).SetTextColor(UiColor(0x9ca3af)).SetMargin(Extents(0, 0, 11, 0)),
                }),
                View::New().SetRequestedWidth(MATCH_PARENT).SetRequestedHeight(3.5f),
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetAlignItems(FlexAlign::FLEX_END).Children({
                    Label::New("$2,400.00").SetFontSize(53).SetTextColor(UiColor(0xffffff)),
                    Label::New("▲ 0.88%").SetFontSize(42).SetTextColor(UiColor(0x22c55e)).SetMargin(Extents(0, 0, 11, 0)),
                }),
            }),
        ...
        FlexLayout::New()
            ...
            .Children({
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetAlignItems(FlexAlign::CENTER).Children({
                    Label::New("◈").SetFontSize(77).SetTextColor(UiColor(0x7c3aed)),
                    Label::New("Portfolio").SetFontSize(35).SetTextColor(UiColor(0x7c3aed)).SetMargin(Extents(0, 0, 14, 0)),
                }),
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetAlignItems(FlexAlign::CENTER).Children({
                    Label::New("◉").SetFontSize(77).SetTextColor(UiColor(0x6b7190)),
                    Label::New("Markets").SetFontSize(35).SetTextColor(UiColor(0x6b7190)).SetMargin(Extents(0, 0, 14, 0)),
                }),
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetAlignItems(FlexAlign::CENTER).Children({
                    Label::New("⇄").SetFontSize(77).SetTextColor(UiColor(0x6b7190)),
                    Label::New("Trade").SetFontSize(35).SetTextColor(UiColor(0x6b7190)).SetMargin(Extents(0, 0, 14, 0)),
                }),
                FlexLayout::New().SetDirection(FlexDirection::COLUMN).SetAlignItems(FlexAlign::CENTER).Children({
                    Label::New("◎").SetFontSize(77).SetTextColor(UiColor(0x6b7190)),
                    Label::New("Profile").SetFontSize(35).SetTextColor(UiColor(0x6b7190)).SetMargin(Extents(0, 0, 14, 0)),
                }),
            }),
    });
