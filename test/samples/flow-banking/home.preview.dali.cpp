...
headerBell.AddChildren({ headerBellIcon });
header.AddChildren({
    headerLeft,
    headerBell,
});
...
balanceTrend.AddChildren({ balanceTrendLabel });
...
actionSendIcon.AddChildren({ actionSendGlyph });
...
actionRequestIcon.AddChildren({ actionRequestGlyph });
...
actionTransferIcon.AddChildren({ actionTransferGlyph });
...
actionTopupIcon.AddChildren({ actionTopupGlyph });
...
txn1Icon.AddChildren({ txn1IconGlyph });
...
txn2Icon.AddChildren({ txn2IconGlyph });
...
txn3Icon.AddChildren({ txn3IconGlyph });
...
txn4Icon.AddChildren({ txn4IconGlyph });
...
txn5Icon.AddChildren({ txn5IconGlyph });
