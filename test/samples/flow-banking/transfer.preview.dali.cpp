    ...
    .Children({
        ...
        FlexLayout::New()
            ...
            .Children({
                ...
                FlexLayout::New().Direction(FlexDirection::ROW).JustifyContent(FlexJustify::CENTER).AlignItems(FlexAlign::CENTER).SetBackgroundColor(UiColor(0x0a3a33)).SetCornerRadius(56.0f).SetViewPadding(Extents(49, 49, 25, 25)).Children({
        ...
        FlexLayout::New()
            ...
            .Children({
                FlexLayout::New().Direction(FlexDirection::COLUMN).JustifyContent(FlexJustify::CENTER).AlignItems(FlexAlign::CENTER).SetRequestedWidth(168.0f).SetRequestedHeight(168.0f).SetBackgroundColor(UiColor(0x00d4a8)).SetCornerRadius(49.0f).Children({
                    Label::New("flow.").SetFontSize(39).SetTextColor(UiColor(0x0d1117)),
                }),
                FlexLayout::New().Direction(FlexDirection::COLUMN).AlignItems(FlexAlign::FLEX_START).SetRequestedWidth(1260.0f).SetViewMargin(Extents(49, 0, 0, 0)).Children({
                    Label::New("FROM").SetFontSize(35).SetTextColor(UiColor(0x5e6673)),
                    Label::New("Flow Debit · •••• 4821").SetFontSize(49).SetTextColor(UiColor(0xffffff)).SetViewMargin(Extents(0, 0, 11, 0)),
                }),
                ...
                FlexLayout::New().Direction(FlexDirection::COLUMN).AlignItems(FlexAlign::FLEX_END).Children({
                    ...
                    Label::New("$12,486.92").SetFontSize(49).SetTextColor(UiColor(0xffffff)).SetViewMargin(Extents(0, 0, 11, 0)),
                }),
            }),
        ...
        FlexLayout::New()
            ...
            .Children({
                // Add new slot
                FlexLayout::New().Direction(FlexDirection::COLUMN).AlignItems(FlexAlign::CENTER).SetRequestedWidth(336.0f).Children({
                    FlexLayout::New().Direction(FlexDirection::COLUMN).JustifyContent(FlexJustify::CENTER).AlignItems(FlexAlign::CENTER).SetRequestedWidth(224.0f).SetRequestedHeight(224.0f).SetBackgroundColor(UiColor(0x161c24)).SetCornerRadius(112.0f).Children({
                        Label::New("+").SetFontSize(98).SetTextColor(UiColor(0x00d4a8)),
                    }),
                    Label::New("Add").SetFontSize(39).SetTextColor(UiColor(0x5e6673)).SetViewMargin(Extents(0, 0, 28, 0)),
                }),
                // Sarah (selected — teal ring)
                FlexLayout::New().Direction(FlexDirection::COLUMN).AlignItems(FlexAlign::CENTER).SetRequestedWidth(336.0f).Children({
                    FlexLayout::New().Direction(FlexDirection::COLUMN).JustifyContent(FlexJustify::CENTER).AlignItems(FlexAlign::CENTER).SetRequestedWidth(252.0f).SetRequestedHeight(252.0f).SetBackgroundColor(UiColor(0x00d4a8)).SetCornerRadius(126.0f).Children({
                    ...
                    Label::New("Sarah").SetFontSize(39).SetTextColor(UiColor(0xffffff)).SetViewMargin(Extents(0, 0, 21, 0)),
                    Label::New("@sarahm").SetFontSize(32).SetTextColor(UiColor(0x5e6673)).SetViewMargin(Extents(0, 0, 7, 0)),
                }),
                // David
                FlexLayout::New().Direction(FlexDirection::COLUMN).AlignItems(FlexAlign::CENTER).SetRequestedWidth(336.0f).Children({
                    ...
                    Label::New("David").SetFontSize(39).SetTextColor(UiColor(0xffffff)).SetViewMargin(Extents(0, 0, 28, 0)),
                    Label::New("@dlee").SetFontSize(32).SetTextColor(UiColor(0x5e6673)).SetViewMargin(Extents(0, 0, 7, 0)),
                }),
                // Maya
                FlexLayout::New().Direction(FlexDirection::COLUMN).AlignItems(FlexAlign::CENTER).SetRequestedWidth(336.0f).Children({
                    ImageView::New("/home/woochan/tizen/paperclip/test/samples/assets/portrait4.jpg")
                        ...
                        .SetRequestedHeight(224.0f)
                        .SetCornerRadius(112.0f),
                    Label::New("Maya").SetFontSize(39).SetTextColor(UiColor(0xffffff)).SetViewMargin(Extents(0, 0, 28, 0)),
                    Label::New("@mrossi").SetFontSize(32).SetTextColor(UiColor(0x5e6673)).SetViewMargin(Extents(0, 0, 7, 0)),
                }),
                // Chris
                FlexLayout::New().Direction(FlexDirection::COLUMN).AlignItems(FlexAlign::CENTER).SetRequestedWidth(336.0f).Children({
                    ImageView::New("/home/woochan/tizen/paperclip/test/samples/assets/portrait5.jpg")
                        ...
                        .SetRequestedHeight(224.0f)
                        .SetCornerRadius(112.0f),
                    Label::New("Chris").SetFontSize(39).SetTextColor(UiColor(0xffffff)).SetViewMargin(Extents(0, 0, 28, 0)),
                    Label::New("@cpark").SetFontSize(32).SetTextColor(UiColor(0x5e6673)).SetViewMargin(Extents(0, 0, 7, 0)),
                }),
            }),
        ...
        FlexLayout::New()
            ...
            .Children({
                ...
                Label::New("Dinner split — thanks!").SetFontSize(49).SetTextColor(UiColor(0xffffff)).SetViewMargin(Extents(49, 0, 0, 0)),
            }),
        ...
        FlexLayout::New()
            ...
            .Children({
                FlexLayout::New().Direction(FlexDirection::ROW).AlignItems(FlexAlign::CENTER).SetRequestedWidth(752.5f).SetRequestedHeight(210.0f).SetBackgroundColor(UiColor(0x00d4a8)).SetCornerRadius(56.0f).SetViewPadding(Extents(49, 49, 0, 0)).Children({
                    Label::New("⚡").SetFontSize(70).SetTextColor(UiColor(0x0d1117)),
                    FlexLayout::New().Direction(FlexDirection::COLUMN).AlignItems(FlexAlign::FLEX_START).SetViewMargin(Extents(35, 0, 0, 0)).Children({
                        Label::New("Instant").SetFontSize(42).SetTextColor(UiColor(0x0d1117)),
                        Label::New("Free, 1 sec").SetFontSize(35).SetTextColor(UiColor(0x0a3a33)).SetViewMargin(Extents(0, 0, 7, 0)),
                    }),
                }),
                FlexLayout::New().Direction(FlexDirection::ROW).AlignItems(FlexAlign::CENTER).SetRequestedWidth(752.5f).SetRequestedHeight(210.0f).SetBackgroundColor(UiColor(0x161c24)).SetCornerRadius(56.0f).SetViewPadding(Extents(49, 49, 0, 0)).Children({
                    Label::New("◉").SetFontSize(70).SetTextColor(UiColor(0x9ba1b0)),
                    FlexLayout::New().Direction(FlexDirection::COLUMN).AlignItems(FlexAlign::FLEX_START).SetViewMargin(Extents(35, 0, 0, 0)).Children({
                        Label::New("Standard").SetFontSize(42).SetTextColor(UiColor(0xffffff)),
                        Label::New("1–2 days").SetFontSize(35).SetTextColor(UiColor(0x5e6673)).SetViewMargin(Extents(0, 0, 7, 0)),
                    }),
                }),
                FlexLayout::New().Direction(FlexDirection::ROW).AlignItems(FlexAlign::CENTER).SetRequestedWidth(752.5f).SetRequestedHeight(210.0f).SetBackgroundColor(UiColor(0x161c24)).SetCornerRadius(56.0f).SetViewPadding(Extents(49, 49, 0, 0)).Children({
                    Label::New("◎").SetFontSize(70).SetTextColor(UiColor(0x9ba1b0)),
                    FlexLayout::New().Direction(FlexDirection::COLUMN).AlignItems(FlexAlign::FLEX_START).SetViewMargin(Extents(35, 0, 0, 0)).Children({
                        ...
                        Label::New("$15 fee").SetFontSize(35).SetTextColor(UiColor(0x5e6673)).SetViewMargin(Extents(0, 0, 7, 0)),
                    }),
                }),
            }),
        ...
        FlexLayout::New()
            ...
            .SetCornerRadius(70.0f)
            .SetViewMargin(Extents(70, 70, 0, 0))
            .SetViewPadding(Extents(70, 70, 56, 56))
            .Children({
                FlexLayout::New().Direction(FlexDirection::ROW).JustifyContent(FlexJustify::SPACE_BETWEEN).SetRequestedWidth(MATCH_PARENT).Children({
        ...
        FlexLayout::New()
            ...
            .Children({
                ...
                FlexLayout::New().Direction(FlexDirection::COLUMN).AlignItems(FlexAlign::CENTER).Children({
                    ...
                    Label::New("Transfer").SetFontSize(35).SetTextColor(UiColor(0x00d4a8)).SetViewMargin(Extents(0, 0, 14, 0)),
                }),
                FlexLayout::New().Direction(FlexDirection::COLUMN).AlignItems(FlexAlign::CENTER).Children({
                    Label::New("◎").SetFontSize(77).SetTextColor(UiColor(0x5e6673)),
